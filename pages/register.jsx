      ...
      try {
        ...
        try {
          await updateProfile(currentUser.user, {
            displayName: JSON.stringify({userName,fullName}),
            ...
            <div className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center hidden">
              <div>
                ...
                <p className="text-white mt-1">
                  used by millions of users every day, is the most popular chat
                  app in the world.
                </p>
                <button
                  type="submit"
            ...
            <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
              ...
              >
                ...
                <div className=" flex justify-center">
                  ...
                  />
                  <label
                    className=" border-4 w-30 h-30 rounded-full flex items-center justify-center border-[#5C2CC3] cursor-pointer"
                    htmlFor="ProfileImg"
                  >
                    <Image
