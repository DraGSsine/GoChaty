...
import FeedLoading from "@/components/LoadingSkeleton/FeedLoading";
const SingIn = () => {
    ...
    try {
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          fullName: JSON.parse(auth.currentUser.displayName).fullName,
        })
      );
      setLoading(false);
    } catch (error) {
      ...
      {!Loading ? (
        <section className="bg-[#F4F7FF] py-20 lg:py-[48px]">
          {ErrorMessage && (
            <div
              id="alert-border-2"
              class="flex absolute top-0 z-30 p-6 mb-4 w-full text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800"
              role="alert"
            >
              <svg
            ...
            <div className="flex flex-wrap">
              <div className="w-full">
                <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]">
                  ...
                  <a className="mb-2 inline-block text-base text-[#adadad] hover:text-primary hover:underline">
                    Forget Password?
                  </a>
                  <p className="text-base text-[#adadad]">
                    Not a member yet?
                    <Link href="/register">
                      <span className=" cursor-pointer text-[#5b2dc3] hover:underline">
                        Sign Up
                      </span>
                    </Link>
                  </p>
